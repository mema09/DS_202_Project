...
Using minimum wage and the cost of living index, Arizona is the best state to live in, and Pennsylvania is the worst. Arizona was the 9th lowest in cost of living, whereas Pennsylvania was the 38th highest of 132. Cost of living by city was comparable to states after taking the medians grouped by state.
From the summary statistics we obtained an r-squared score of 0.9989 and a p-value of 0.0134 which was an indicator on how well the data could fit the linear model, as well as indicating that it was statistically significant. This lead us to believe that on average as in state tuition rates increased so did out of state tuition rates
