...
* Since the linear model is very simple, the easiest way to predict is to use the coefficient estimates from the model.
* From the linear model we can see how well the data was fitted to the model based on the r-squared of 0.9988.
* This helped us determine that on on average in state and out of state tuition are linearly related.
